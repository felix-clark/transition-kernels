...
In the limit of $\alpha=0$, this reverts back to a total re-shuffling. In the limit of $\alpha \rightarrow \infty$, the left and right halves are re-shuffled separately.
